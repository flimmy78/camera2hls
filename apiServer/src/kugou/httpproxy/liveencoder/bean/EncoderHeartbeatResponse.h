...
#ifndef ENCODERHEARTBEATSPONSE_BEAN_SERVER_KUGOU_H
#define ENCODERHEARTBEATSPONSE_BEAN_SERVER_KUGOU_H
...
struct EncoderHeartbeatResponse : public kugou::base::facility::Json
{
	std::string Result;
