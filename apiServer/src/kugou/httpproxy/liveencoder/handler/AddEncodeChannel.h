...
#ifndef ADDCHANNEL_HANDLE_SERVER_KUGOU_H
#define ADDCHANNEL_HANDLE_SERVER_KUGOU_H
...
class AddEncodeChannel : public kugou::base::net::ImplHandler<kugou::httpproxy::liveencoder::bean::AddChannelRequest, kugou::httpproxy::liveencoder::bean::AddChannelResponse>
{
public:
    AddEncodeChannel(kugou::httpproxy::liveencoder::encoder::LibraryImpl& el)
        : m_el(el)
    {
    }
	std::string name()
	{
		return ADDCHANNELREQUEST_API;
	}
protected:
    ...
    {
        return new AddEncodeChannel(m_el);
    }
