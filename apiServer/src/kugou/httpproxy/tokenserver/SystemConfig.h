...
#ifndef SYSTEMCONFIG_TOKENSERVER_HTTPPROXY_KUGOU_H
#define SYSTEMCONFIG_TOKENSERVER_HTTPPROXY_KUGOU_H
...
public:
	...
	std::string& getWhiteListFileName();
	std::string& getFIFOFileName();
...
private:
	std::string m_strWhiteListFileName;
	std::string m_strFifoFileName;
};
