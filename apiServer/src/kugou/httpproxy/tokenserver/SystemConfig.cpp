...
void SystemConfig::initConfigDesc(program_options::options_description& desc)
{
	...
	("SYS.WhiteListFileName", value2(string, &m_strWhiteListFileName), "White List File Name")
	("SYS.FifoFileName", value2(string, &m_strFifoFileName)->default_value("./fifo"), "FIFO File Name")
...
std::string& SystemConfig::getWhiteListFileName()
{
	return m_strWhiteListFileName;
}

std::string& SystemConfig::getFIFOFileName()
{
	return m_strFifoFileName;
}
