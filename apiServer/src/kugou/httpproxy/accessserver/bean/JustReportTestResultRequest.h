...
#ifndef JUSTREPORTTESTRESULTREQUEST_BEAN_ACCESSSERVER_HTTPPROXY_KUGOU_H
#define JUSTREPORTTESTRESULTREQUEST_BEAN_ACCESSSERVER_HTTPPROXY_KUGOU_H
...
struct JustReportTestResultRequest : public kugou::base::facility::Json
{
    int             UsageType;
    int             UserType;
    std::string     UserID;
    ...
    JustReportTestResultRequest(void)
        : UsageType(-1)
        , UserType(-1)
    {
    }
