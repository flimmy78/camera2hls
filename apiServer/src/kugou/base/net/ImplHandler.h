...
#ifndef IMPLHANDLER_NET_BASE_KUGOU_H
#define IMPLHANDLER_NET_BASE_KUGOU_H
...
class ImplHandler : public kugou::base::net::Handler
{
public:
	ImplHandler(){}
...
protected:
    ...
    virtual bool parser(const std::string& inJson, std::string& outJson)
    {
    	try
    	{
            ...
            {
                outJson = kugou::base::net::GeneralError("JSON_ERROR", "parse json error").toJson();
                return false;
            }
    	...
    	catch(...)
    	{
    		...
    		outJson = kugou::base::net::GeneralError("PARAM_ERROR", "parse json error").toJson();
    		return false;
    	}
    }
